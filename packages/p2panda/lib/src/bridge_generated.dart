...
Future<Uint8List> signAndEncodeEntry({ required String logId ,required String seqNum ,String? skiplinkHash ,String? backlinkHash ,required Uint8List payload ,required KeyPair keyPair ,dynamic hint });
...
Future<(String,String,String,String?,String?)> decodeEntry({ required Uint8List entry ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kDecodeEntryConstMeta;

/// Encode a p2panda operation parsed from JSON input.
Future<Uint8List> encodeOperation({ required OperationAction action ,required String schemaId ,String? previous ,List<(String,OperationValue)>? fields ,dynamic hint });
...
Future<(OperationAction,String)> decodeOperation({ required Uint8List operation ,dynamic hint });
...
Future<void> startNode({ required String logLevel ,required KeyPair keyPair ,required String databaseUrl ,required String blobsBasePath ,required List<String> relayAddresses ,required List<String> allowSchemaIds ,dynamic hint });
...
Future<KeyPair> fromPrivateKeyStaticMethodKeyPair({ required Uint8List bytes ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kFromPrivateKeyStaticMethodKeyPairConstMeta;

/// Returns the private half of the key pair.
Future<Uint8List> privateKeyMethodKeyPair({ required KeyPair that ,dynamic hint });

FlutterRustBridgeTaskConstMeta get kPrivateKeyMethodKeyPairConstMeta;

/// Returns the public half of the key pair.
Future<Uint8List> publicKeyMethodKeyPair({ required KeyPair that ,dynamic hint });
...
@sealed class PandaKeyPair extends FrbOpaque {
                final P2Panda bridge;
                PandaKeyPair.fromRaw(int ptr, int size, this.bridge) : super.unsafe(ptr, size);
                @override
...
final PandaKeyPair field0;
                    ...
                    const KeyPair({required this.bridge,required this.field0 ,});

                /// Generates a new key pair using the systems random number generator (CSPRNG) as a seed.
static Future<KeyPair> newKeyPair({ required P2Panda bridge,dynamic hint })=>bridge.newStaticMethodKeyPair(hint: hint);

/// Derives a key pair from a private key.
static Future<KeyPair> fromPrivateKey({ required P2Panda bridge,required Uint8List bytes ,dynamic hint })=>bridge.fromPrivateKeyStaticMethodKeyPair(bytes:bytes,hint: hint);

/// Returns the private half of the key pair.
 Future<Uint8List> privateKey({ dynamic hint })=>bridge.privateKeyMethodKeyPair(that: this, );

/// Returns the public half of the key pair.
 Future<Uint8List> publicKey({ dynamic hint })=>bridge.publicKeyMethodKeyPair(that: this, );
...
final String msg;
                    ...
                    const LogEntry({required this.timestamp ,required this.level ,required this.tag ,required this.msg ,});
...
@freezed
                sealed class OperationValue with _$OperationValue  {
                     /// Boolean value.
const factory OperationValue.boolean(  bool field0,) = OperationValue_Boolean;
 /// Floating point value.
const factory OperationValue.float(  double field0,) = OperationValue_Float;
 /// Signed integer value.
const factory OperationValue.integer(  int field0,) = OperationValue_Integer;
 /// String value.
const factory OperationValue.string(  String field0,) = OperationValue_String;
 /// Bytes value.
const factory OperationValue.bytes(  Uint8List field0,) = OperationValue_Bytes;
 /// Reference to a document.
const factory OperationValue.relation(  String field0,) = OperationValue_Relation;
 /// Reference to a list of documents.
const factory OperationValue.relationList(  List<String> field0,) = OperationValue_RelationList;
 /// Reference to a document view.
///
/// Multiple operation ids are separated by an understore ('_').
const factory OperationValue.pinnedRelation(  String field0,) = OperationValue_PinnedRelation;
 /// Reference to a list of document views.
///
/// Multiple operation ids are separated by an understore ('_').
const factory OperationValue.pinnedRelationList(  List<String> field0,) = OperationValue_PinnedRelationList;
                }
...
Stream<LogEntry> subscribeLogStream({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kSubscribeLogStreamConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg5 = _platform.api2wire_box_autoadd_key_pair(keyPair);
            ...
            callFfi: (port_) => _platform.inner.wire_sign_and_encode_entry(port_, arg0, arg1, arg2, arg3, arg4, arg5),
        ...
        FlutterRustBridgeTaskConstMeta get kSignAndEncodeEntryConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "sign_and_encode_entry",
            argNames: ["logId", "seqNum", "skiplinkHash", "backlinkHash", "payload", "keyPair"],
        );
...
Future<(String,String,String,String?,String?)> decodeEntry({ required Uint8List entry ,dynamic hint }) {
            ...
            parseSuccessData: _wire2api___record__String_String_String_opt_String_opt_String,
            parseErrorData: _wire2api_FrbAnyhowException,
        ...
        FlutterRustBridgeTaskConstMeta get kDecodeEntryConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg3 = _platform.api2wire_opt_list___record__String_operation_value(fields);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_encode_operation(port_, arg0, arg1, arg2, arg3),
            parseSuccessData: _wire2api_uint_8_list,
            parseErrorData: _wire2api_FrbAnyhowException,
        ...
        FlutterRustBridgeTaskConstMeta get kEncodeOperationConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<(OperationAction,String)> decodeOperation({ required Uint8List operation ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kDecodeOperationConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg5 = _platform.api2wire_StringList(allowSchemaIds);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_start_node(port_, arg0, arg1, arg2, arg3, arg4, arg5),
            parseSuccessData: _wire2api_unit,
            parseErrorData: _wire2api_FrbAnyhowException,
            
        constMeta: kStartNodeConstMeta,
        argValues: [logLevel, keyPair, databaseUrl, blobsBasePath, relayAddresses, allowSchemaIds],
        hint: hint,
        ...
        FlutterRustBridgeTaskConstMeta get kStartNodeConstMeta => const FlutterRustBridgeTaskConstMeta(
            ...
            argNames: ["logLevel", "keyPair", "databaseUrl", "blobsBasePath", "relayAddresses", "allowSchemaIds"],
        );
...
Future<void> shutdownNode({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kShutdownNodeConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<KeyPair> newStaticMethodKeyPair({ dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_new__static_method__KeyPair(port_),
        ...
        FlutterRustBridgeTaskConstMeta get kNewStaticMethodKeyPairConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<KeyPair> fromPrivateKeyStaticMethodKeyPair({ required Uint8List bytes ,dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_from_private_key__static_method__KeyPair(port_, arg0),
            parseSuccessData: (d) => _wire2api_key_pair(d),
            parseErrorData: _wire2api_FrbAnyhowException,
        ...
        FlutterRustBridgeTaskConstMeta get kFromPrivateKeyStaticMethodKeyPairConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<Uint8List> privateKeyMethodKeyPair({ required KeyPair that ,dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_private_key__method__KeyPair(port_, arg0),
            parseSuccessData: _wire2api_uint_8_list,
            parseErrorData: null,
        ...
        FlutterRustBridgeTaskConstMeta get kPrivateKeyMethodKeyPairConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<Uint8List> publicKeyMethodKeyPair({ required KeyPair that ,dynamic hint }) {
            var arg0 = _platform.api2wire_box_autoadd_key_pair(that);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_public_key__method__KeyPair(port_, arg0),
            parseSuccessData: _wire2api_uint_8_list,
            parseErrorData: null,
        ...
        FlutterRustBridgeTaskConstMeta get kPublicKeyMethodKeyPairConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "public_key__method__KeyPair",
            argNames: ["that"],
        );
        

        DropFnType get dropOpaquePandaKeyPair => _platform.inner.drop_opaque_PandaKeyPair;
        ShareFnType get shareOpaquePandaKeyPair => _platform.inner.share_opaque_PandaKeyPair;
        OpaqueTypeFinalizer get PandaKeyPairFinalizer => _platform.PandaKeyPairFinalizer;
...
(String,String,String,String?,String?) _wire2api___record__String_String_String_opt_String_opt_String(dynamic raw) {
            final arr = raw as List<dynamic>;
            if (arr.length != 5) {
                throw Exception('Expected 5 elements, got ${arr.length}');
            }
            return (_wire2api_String(arr[0]),_wire2api_String(arr[1]),_wire2api_String(arr[2]),_wire2api_opt_String(arr[3]),_wire2api_opt_String(arr[4]),);
        }
        

(OperationAction,String) _wire2api___record__operation_action_String(dynamic raw) {
            final arr = raw as List<dynamic>;
            if (arr.length != 2) {
                throw Exception('Expected 2 elements, got ${arr.length}');
            }
            return (_wire2api_operation_action(arr[0]),_wire2api_String(arr[1]),);
        }
...
LogEntry _wire2api_log_entry(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return LogEntry(timestamp: _wire2api_u64(arr[0]),
...
@protected
                    ffi.Pointer<wire_list___record__String_operation_value> api2wire_list___record__String_operation_value(List<(String,OperationValue)> raw) {
                        final ans = inner.new_list___record__String_operation_value_0(raw.length);
                for (var i = 0; i < raw.length; ++i) {
                    _api_fill_to_wire___record__String_operation_value(raw[i], ans.ref.ptr[i]);
                }
                return ans;
...
@protected
                    ffi.Pointer<wire_list___record__String_operation_value> api2wire_opt_list___record__String_operation_value(List<(String,OperationValue)>? raw) {
                        return raw == null ? ffi.nullptr : api2wire_list___record__String_operation_value(raw);
                    }
...
late final OpaqueTypeFinalizer _PandaKeyPairFinalizer = OpaqueTypeFinalizer(inner._drop_opaque_PandaKeyPairPtr);
            OpaqueTypeFinalizer get PandaKeyPairFinalizer => _PandaKeyPairFinalizer;
// Section: api_fill_to_wire

void _api_fill_to_wire_PandaKeyPair(PandaKeyPair apiObj, wire_PandaKeyPair wireObj) {
...
void _api_fill_to_wire___record__String_operation_value((String,OperationValue) apiObj, wire___record__String_operation_value wireObj) {
...
void _api_fill_to_wire_box_autoadd_key_pair(KeyPair apiObj, ffi.Pointer<wire_KeyPair> wireObj) {
...
void _api_fill_to_wire_operation_value(OperationValue apiObj, wire_OperationValue wireObj) {
